	...
	<div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<c:url value ='/quan-tri/bai-viet/danh-sach'/>">Bài Viết</a></li>
				...
				<div class="col-xs-12">
					...
					<form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
						<div class="form-group">
								...
								<div class="col-sm-9">
									<form:input path="tieude" cssClass="col-xs-10 col-sm-5"/>
								</div>
						</div>
						<div class="form-group">
						  	<label for="mota" class="col-sm-3 control-label no-padding-right">Chi tiết bài viết</label>
						  	<div class="col-sm-9">
