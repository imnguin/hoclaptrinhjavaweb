...
<body>
	<div class="main-content">
		<form action="<c:url value='/quan-tri/tai-khoan/danh-sach'/>"
								...
								<div class="table-btn-controls">
									<div class="pull-right tableTools-container">
										<div class="dt-buttons btn-overlap btn-group">
											<c:url var="createAccountURL"
												value="/quan-tri/tai-khoan/chinh-sua" />
											<a flag="info"
												class="dt-button buttons-colvis btn btn-white btn-primary btn-bold"
												data-toggle="tooltip" title='Thêm tài khoản'
												href='${createAccountURL}' onclick="alert('Chức năng vẫn chưa hoàn thiện!')"> <span> <i
			...
			$
					.ajax({
						...
						success : function(result) {
							window.location.href = "${accountURL}?&message=delete_success";
						},
